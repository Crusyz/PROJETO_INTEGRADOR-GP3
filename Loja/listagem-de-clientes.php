...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search" method="post" action="localiza-cliente.php">
                        <input class="form-control me-2" name="nomeCliente" type="search" placeholder="Buscar na loja" aria-label="Search">
            ...
            <tbody>
                <?php foreach (fnLocalizaClientePorNome($nome) as $cliente) : ?>
                    <tr>
                        ...
                        <td style="background-color: white;"><a href="#" onclick="gerirUsuario(<?= $cliente->id ?>, 'edit');">Editar</a></td>
                        <td style="background-color: white;"><a href="#" onclick="return confirm('Deseja realmente excluir?') ? gerirUsuario(<?= $cliente->id ?>, 'del') : '';">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div>
        <button type="submit" class="btn btn-dark"><a style="color: white; text-decoration: none;" href="formulario-cadastro-cliente.php">Cadastrar Novo
                Cliente</a></button>
    </div>
    <script>
        window.post = (data) => {
