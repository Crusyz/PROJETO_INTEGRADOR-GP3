...
define('GUSER', 'marcus.senac2021.3@gmail.com');
...
function send($usuario)
{
    ...
    $mail->isSMTP();
    $mail->SMTPDebug = 0; # 0 - não debugar, 1 - client message, 2 - server e client message
    ...
    $mail->setFrom('mvjs2004@gmail.com', 'Triplo|Loja');
...
function constroiMensagem($senha)
{
    return   "<!DOCTYPE html>"
        ...
        . "</head>"
        . "<body>"
        . "<h1>Recuperação de senha <strong>Loja</strong></h1>"
        . "<div align='center'>"
